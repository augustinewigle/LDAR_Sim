...
# File:        external_sensors.bayesian_2
...
def detect_emissions(
    ...
    measured rate = (alpha0+alpha1*true_rate)*exp(error) where error ~ N(0, (tau+true_rate/eta)^{-1}) #truck tdlas

    Uses four inputs to determine the distribution:
        alpha0 
        alpha1
        tau
        eta
    Supply through QE parameter: Qe = [alpha0, alpha1, tau, eta]
